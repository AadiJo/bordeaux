...
const bordeauxAPI = {
  ...
  acknowledgeAgentProposal: (proposalId: string, sessionId: string, revision: number, accepted = true) => ipcRenderer.send("agent:proposalReceipt", proposalId, sessionId, revision, accepted),
